...
- (void)viewDidLoad
{
    ...
    timerImage.image = [UIImage animatedImageWithAnimatedGIFURL:[NSURL URLWithString:@"http://i.imgur.com/jTtotAl.gif"]];
    ...
    today = [NSDate date];
    HShacksBegin = [formatter dateFromString:@"06/13/2014 1:00:00"];
    HShacksEnd = [formatter dateFromString:@"06/014/2014 13:00:00"];
...
-(void)countdownDisplay:(id)sender{
    ...
    if(isStarting){
        ...
        countdown.text = @"We hope you enjoyed SoHacks!";
    }
}
...
-(void)setStuff{
    ...
    if(isStarting){
        ...
        countdown.text = @"We hope you enjoyed SoHacks! Come back next year!";
    }
